...
| `vision/charter.md` | The concrete scope, maturity target, and first principles governing this effort. Start here. |
...
| `analysis/data-generation-analysis.md` | Analysis of the data-generation approach and generators — personas, cost, and the signals they produce. |

## Working principles (summary — see `vision/charter.md` for the authoritative statement)
...
- Read `vision/charter.md` first for scope and constraints, then the ADR log in `adr/README.md` for the decisions and their rationale.
